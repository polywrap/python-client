...
from .mocker import MockSubinvokePluginResolver, mock_plugin_extension_resolver, MockPluginExtensionResolver, mock_subinvoke_plugin_resolver
...
def test_can_resolve_uri_with_plugin_extension(client: PolywrapClient) -> None:
    ...
    from .histories.not_a_match_with_subinvoke import EXPECTED
